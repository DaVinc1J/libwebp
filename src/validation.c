...
#ifdef NDEBUG
const bool8 enable_validation_layers = false;
#else
const bool8 enable_validation_layers = true;
#endif
...
bool8 verify_extensions_support(u32 extensions_count, VkExtensionProperties *extensions, u32 glfw_extensions_count, const char **glfw_extensions) {
...
bool8 check_validation_layer_support() {
	u32 layer_count;
